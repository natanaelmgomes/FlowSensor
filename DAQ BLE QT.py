...
from PyQt6.QtGui import QPalette, QColor, QIcon, QPixmap, QKeySequence, QGuiApplication, QAction, QShortcut
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.agent.errorOccurred.connect(self.deviceScanError)
    ...
    def scientific_widget(self):
        ...
        self.flow_label.setFrameStyle(QFrame.Shape.NoFrame)
        ...
        right_layout.addSpacing(10)
        right_layout.setAlignment(self.device_combo_sc, Qt.AlignmentFlag.AlignTop)
    ...
    def user_widget(self):
        ...
        self.flow_label2.setFrameStyle(QFrame.Shape.NoFrame)
    ...
    def start_button_click(self) -> None:
        ...
        if self.activeBLE:
            ...
            self.BLE_service.errorOccurred.connect(self.handleServiceError)
            ...
            elif self.BLE_service.state() == QtBt.QLowEnergyService.ServiceState.DiscoveryRequired:
    ...
    def _resize_window(self):
        ...
        qr = self.frameGeometry()
        cp = QGuiApplication.availableGeometry().center()
        qr.moveCenter(cp)
        center = qr.topLeft()
        if center.y() < 0:
            center.setY(0)
